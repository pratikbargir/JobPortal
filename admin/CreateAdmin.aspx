                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:Image ID="Image4" runat="server" BorderColor="Black" BorderWidth="2px" 
                                Height="184px" ImageUrl="~/images/JPRS-banner-icon.png" Width="205px" 
                                BackColor="White" />
                        <br />
                        </td>
                        <td>
                    ...
                    <tr >
                        <td class="style8" >
                            ...
                            <asp:TextBox ID="TextU_nm1" runat="server" Height="35px" 
                                placeholder="Enter Username" Width="220px" style="text-align: left" 
                                BackColor="White" ontextchanged="TextU_nm1_TextChanged1"></asp:TextBox>
                        </td>
                        <td class="style9">
                    ...
                    <tr>
                        <td class="style8">
                            ...
                            <asp:TextBox ID="TextPass" runat="server" Height="35px" 
                                placeholder="Enter Password" Width="220px" TextMode="Password"></asp:TextBox>
                    ...
                    <tr>
                        <td class="style8">
                            ...
                            <asp:TextBox ID="TextC_pass" runat="server" Height="35px" 
                                placeholder="Confirm Password" Width="220px" TextMode="Password"></asp:TextBox>
                        </td>
                        <td class="style9">
