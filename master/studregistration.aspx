<%@ Page Language="C#" MasterPageFile="~/master/home.master" AutoEventWireup="true" EnableEventValidation ="false" CodeFile="studregistration.aspx.cs" Inherits="master_studregistration" Title="Untitled Page" %>
        ...
        <table align="center" class="style17">
           ...
           <tr>
               <td>
                   Password</td>
               <td>
                   <asp:TextBox ID="txtpassword" runat="server" Height="25" Width="200" 
           ...
           <tr>
               <td>
                   Confirm Password</td>
               <td>
                   <asp:TextBox ID="txtconfirmpasswd" runat="server" Height="25" Width="200" 
                       TextMode="Password"></asp:TextBox>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <asp:Button ID="btnuploadimg" runat="server"  
                       Text="Upload" Height="25"  onclick="btnuploadimg_Click" BackColor="#333333" Font-Bold="True" ForeColor="White" 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           <tr>
               <td class="style22">
                   Address</td>
               <td class="style23">
                   <asp:TextBox ID="txtaddr" runat="server" TextMode="MultiLine" Height="50px" 
           ...
           <tr>
               <td class="style20">
                   State</td>
               <td>
                   <asp:TextBox ID="txtstate" runat="server" Height="25" Width="200" 
                   ></asp:TextBox>
   ...
   <legend class="style15">Candidate Education Details</legend>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drpsscin" runat="server" Height="25" Width="200">
                                            ...
                                            <asp:ListItem>Pune Divisional Board</asp:ListItem>
                                            <asp:ListItem>Mumbai Divisional Board</asp:ListItem>
                                            <asp:ListItem>Aurangabad Divisional Board</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="drphscin" runat="server" Height="25" Width="200">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem Value="Kolhapur Divisional Board ">Kolhapur Divisional Board</asp:ListItem>
                                            <asp:ListItem>Pune Divisional Board</asp:ListItem>
                                            <asp:ListItem>Mumbai Divisional Board</asp:ListItem>
                                            <asp:ListItem>Aurangabad Divisional Board</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drpgradin" runat="server" Height="25" Width="200">
                                            ...
                                            <asp:ListItem>Savitribai Phule University ,Pune</asp:ListItem>
                                            <asp:ListItem>Mumbai University
                                            </asp:ListItem>
                                            <asp:ListItem>Nanded University
                                            </asp:ListItem>
                                            <asp:ListItem>Jaypur University,Jaypur
                                            </asp:ListItem>
                                            <asp:ListItem>Solapur University
                                            </asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="drpgradsp" runat="server" Height="25" Width="200">
                                            ...
                                            <asp:ListItem>B.A.(Marathi)</asp:ListItem>
                                            <asp:ListItem>B.A.(English)</asp:ListItem>
                                            <asp:ListItem>B.A.(Hindi)</asp:ListItem>
                                            <asp:ListItem>B.A.(Geoghraphy)</asp:ListItem>
                                            <asp:ListItem>B.A.(History)</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drppgin" runat="server" Height="25" Width="200">
                                            ...
                                            <asp:ListItem>Nanded University</asp:ListItem>
                                            <asp:ListItem>Jaypur University,Jaypur</asp:ListItem>
                                            <asp:ListItem>Solapur University</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="drppgsp" runat="server" Height="25" Width="200">
                                            ...
                                            <asp:ListItem>M.Sc.(Chemistry)</asp:ListItem>
                                            <asp:ListItem>M.Sc.(Physics)</asp:ListItem>
                                            <asp:ListItem>M.Sc.(Maths)</asp:ListItem>
                                            <asp:ListItem>M.Sc.(Statistics)</asp:ListItem>
                                            <asp:ListItem>M.B.A.(Management)</asp:ListItem>
                                            <asp:ListItem>M.B.A.(Finance)</asp:ListItem>
                                            <asp:ListItem>M.C.A.</asp:ListItem>
                                            <asp:ListItem>M.B.A(HR)</asp:ListItem>
                                            <asp:ListItem>M.A.(English)</asp:ListItem>
                                            <asp:ListItem>M.A.(Hindi)</asp:ListItem>
                                            <asp:ListItem>M.A.(History)</asp:ListItem>
                                            <asp:ListItem>M.A.(Geography)</asp:ListItem>
                                            <asp:ListItem>M.A.(Marathi)</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
               ...
               <td>
                   <asp:DropDownList ID="drpphdin" runat="server" Height="25" Width="200">
                       ...
                       <asp:ListItem>Shivaji University Kolhapur</asp:ListItem>
                       <asp:ListItem>Savitribai Phule University,Pune</asp:ListItem>
                       <asp:ListItem>Mumabi University
                       </asp:ListItem>
                       <asp:ListItem>Nanded University
                       </asp:ListItem>
                       <asp:ListItem>Jaypur University,Jaypur</asp:ListItem>
               ...
               <td>
                   <asp:DropDownList ID="drpphdsp" runat="server" Height="25" Width="200">
                       ...
                       <asp:ListItem>Marathi Sahitya</asp:ListItem>
                       <asp:ListItem>Hindi Sahitya</asp:ListItem>
                   </asp:DropDownList>
                                    </td>
               <td>
       ...
       <table align="center" class="style17">
           ...
           <tr>
               <td>
                   Company Name</td>
               <td>
                   <asp:TextBox ID="txtcname" runat="server" Height="25" Width="200"></asp:TextBox>
...
&nbsp;
                   <asp:Button ID="btnuploadresume" runat="server" Text="Upload" Height="25" 
                        onclick="btnuploadresume_Click" BackColor="#333333" Font-Bold="True" ForeColor="White" 
                                style="font-family: Arial, Helvetica, sans-serif; font-size: medium" 
                                Width="100px" />
               </td>
           </tr>
   ...
   <table align="center" class="style17">
        ...
        <tr>
            <td class="style21">
                ...
                <asp:Button ID="btnlogin" runat="server" Text="Submit" Height="25"  onclick="btnlogin_Click" 
