                ...
                <table align="center" class="style2" border="1" frame="void" rules="cols">
                    ...
                    <tr>
                        <td class="style5">
                            ...
                            <cc1:TextBoxWatermarkExtender ID="txtnm_TextBoxWatermarkExtender" 
                                runat="server" Enabled="True" TargetControlID="txtnm" 
                    ...
                    <tr>
                        <td class="style5">
                            ...
                            <cc1:PasswordStrength ID="txtnm12" runat="server" Enabled="True" 
